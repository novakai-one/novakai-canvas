...
import type { CanvasActor, CanvasProvenance } from './records/legacy-operation.ts';
import type { DiagramRecord } from './records/index.ts';
import type { RecordCommand } from './workspace-commands.ts';

export type { RecordCommand } from './workspace-commands.ts';
