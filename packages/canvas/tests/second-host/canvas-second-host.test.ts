...
import type { ActorContext, CanvasWorkspace, DiagramRecord } from '@novakai/canvas';
...
describe('second host', () => {
  ...
  it('keeps the public surface free of framework and storage types', () => {
    const surface = Object.values(
      import.meta.glob('../../contract/index.ts', { query: '?raw', import: 'default', eager: true }),
    )[0] as string;
  ...
  it('keeps the domain and application layers free of hosts, frameworks and I/O', () => {
    ...
    const sources = import.meta.glob(
      ['../../core/domain/**/*.ts', '../../core/application/**/*.ts'],
