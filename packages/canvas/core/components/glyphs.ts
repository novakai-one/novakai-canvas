...
import { ICON_NAMES, type IconName } from '../../contract/records/components.ts';

export const GLYPH_NAMES = ICON_NAMES;

/** One 24×24 outline path per semantic icon. */
export const GLYPHS = {
  brain: 'M12 5v14M12 5a3 3 0 0 0-6 1a3 3 0 0 0-2 5a3 3 0 0 0 2 5a3 3 0 0 0 6 1M12 5a3 3 0 0 1 6 1a3 3 0 0 1 2 5a3 3 0 0 1-2 5a3 3 0 0 1-6 1',
  check: 'M5 12l4 4L19 6',
  clock: 'M12 3a9 9 0 1 0 0 18a9 9 0 0 0 0-18M12 7v5l3 2',
  gauge: 'M12 3a9 9 0 1 0 0 18a9 9 0 0 0 0-18M12 14l4-4',
