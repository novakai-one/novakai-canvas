...
import type { IconCardIcon } from '../../../contract/records/components.ts';
import type { CanvasNode } from '../../../contract/records/index.ts';
import { nodeContentFields } from '../../../contract/schemas/content.ts';
import type { DslNodeDeclaration, DiagramComponent } from '../component.ts';
import { GLYPHS } from '../glyphs.ts';

export const ICON_CARD_ICONS = ICON_NAMES;
...
export const iconCardComponent: DiagramComponent<'icon-card'> = {
  ...
  layoutRole: 'leaf',
  contentFields: nodeContentFields('icon-card'),
  measure(node) {
