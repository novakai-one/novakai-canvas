...
import type { CalloutItem, CalloutKind } from '../../../contract/records/components.ts';
import {
  CALLOUT_KINDS as KINDS, nodeContentFields,
...
export const calloutStackComponent: DiagramComponent<'callout-stack'> = {
  ...
  layoutRole: 'leaf',
  contentFields: nodeContentFields('callout-stack'),
  items(node) {
