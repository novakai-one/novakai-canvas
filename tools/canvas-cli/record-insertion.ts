...
function insertionSlice(
  ...
  const sourceLayout = target.layouts[activeLayoutId(target)];
  ...
  return {
    ...
    layouts: {
      [layoutId]: {
        ...
        appearanceByWireId: {},
        arrangementByContainerId: subset(
          sourceLayout.arrangementByContainerId ?? {}, included,
        ),
      },
    },
    views: {
