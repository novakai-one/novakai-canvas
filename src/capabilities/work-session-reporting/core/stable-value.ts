...
/**
 * Synchronous SHA-256 implemented with integer operations available in browsers.
 *
 * The capability core cannot depend on Node's crypto module and Web Crypto is
 * asynchronous, so deterministic identities use this small FIPS 180-4 routine.
 */
...
/** Full 256-bit deterministic identity digest. */
