...
import { censusOfLegacyDocument } from './census';
import realV1 from './fixtures/real-v1-committed.json' with { type: 'json' };
import realV2 from './fixtures/real-v2-working-copy.json' with { type: 'json' };
